<?php
    ...
    if(@$_SESSION['admin']||@$_SESSION['guru']||@$_SESSION['siswa 11B']){
?> 
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
                <?php
                if(@$_SESSION['siswa 11B']){
                    $user = @$_SESSION['siswa 11B'];
                }
                }
                
                $ambilData = mysqli_query($koneksi,"SELECT * FROM tb_login_11b WHERE kode_user ='$user'");
            $dt = mysqli_fetch_array($ambilData);
                $ambilData = mysqli_query($koneksi,"SELECT * FROM data_siswa_11b WHERE nis ='$user'");
        ...
        <head>
            ...
            <body>
               <form action="" method ="post">
                    ...
                    mysqli_query($koneksi,"INSERT INTO data_siswa_11b SET
                    nis= '$_POST[nis]',
                    nama= '$_POST[nama]',
                    kelas= '$_POST[kelas]',
                    tempat= '$_POST[tempat]',
