               ...
               <form action="" method ="post">
                    ...
                    <?php 
                     if(isset($_POST['proses']))
                     {
                         ...
                         $alamat= $_POST['alamat'];
                         $tlp= $_POST['tlp'];
                         $tambah= mysqli_query($koneksi,"UPDATE  data_siswa_10b SET nama='$nama',kelas='$kelas',tempat='$tempat',tanggal='$tanggal',alamat='$alamat',tlp='$tlp',agama='$agama',jenis='$jenis' WHERE nis='$nis'");
                         if($tambah){
                             ?>
