<?php
    ...
    if(@$_SESSION['admin']||@$_SESSION['guru']||@$_SESSION['siswa 10B']){
?> 
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
                <?php
                if(@$_SESSION['siswa 10B']){
                    $user = @$_SESSION['siswa 10B'];
                }
                }
                
                $ambilData = mysqli_query($koneksi,"SELECT * FROM tb_login_10b WHERE kode_user ='$user'");
            $dt = mysqli_fetch_array($ambilData);
                $ambilData = mysqli_query($koneksi,"SELECT * FROM data_siswa_10b WHERE nis ='$user'");
            ...
            <body>
               <form action="" method ="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="kelas" value="10B" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    mysqli_query($koneksi,"INSERT INTO data_siswa_10b SET
                    nis= '$_POST[nis]',
                    nama= '$_POST[nama]',
                    kelas= '$_POST[kelas]',
                    tempat= '$_POST[tempat]',
