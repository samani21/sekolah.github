<?php
      ...
      $id = $_GET['id'];
      $ambilData = mysqli_query($koneksi,"DELETE FROM nilai_10a WHERE nis='$id'");
...
<html>
    ...
    <div class="wrapper">
        <nav class="sidebar">
            ...
            <ul>
                <li><a href="tambah_nilai.php"><i class="fas fa-plus-circle"></i> Tambah Nilai</a></li>
        ...
        <div class="header"><b>Laporan Nilai Nilai Siswa Kelas 10A<b></div>
        <div class="info">
        <head>
            <meta charset="utf-8">
        ...
        <br>
            <body>
            <a href="cetak_nilai.php"><button type="button" class="btn btn-outline-success btn-lg btn-block">Cetak</button>
            <br>
            ...
            if(isset($_POST['submit'])){
                $cari=$_POST['cari'];
                $query = mysqli_query($koneksi,"SELECT * FROM nilai_10a WHERE nama LIKE '$cari%'");
            }else{
                $query= mysqli_query($koneksi,"SELECT * FROM nilai_10a ORDER BY total DESC ");
            }
        ...
        ?>
            <tr >
                ...
                <td align="center" width="80"><a href="edit-nilai.php?id=<?php echo $data['nis']; ?> ">
                <button type="button" class="btn btn-warning">Edit</button>
                <td align="center" width="80"><a href="hapus-nilai.php?id=<?php echo $data['nis']; ?> ">
