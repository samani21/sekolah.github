<?php
      ...
      $id = $_GET['id'];
      $ambilData = mysqli_query($koneksi,"DELETE FROM nilai_10b WHERE nis='$id'");
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="header"><b>Laporan Nilai Nilai Siswa Kelas 10B<b></div>
        <div class="info">
        <head>
            <meta charset="utf-8">
        ...
        <br>
            <body>
            <a href="cetak_nilai_10b.php"><button type="button" class="btn btn-outline-success btn-lg btn-block">Cetak</button>
            <br>
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    $cari=$_POST['cari'];
                    $query = mysqli_query($koneksi,"SELECT * FROM nilai_10b WHERE nama LIKE '$cari%'");
                }else{
                    $query= mysqli_query($koneksi,"SELECT * FROM nilai_10b ORDER BY total DESC ");
                }
            ...
            ?>
                <tr>
                    ...
                    <td align="center" width="80"><a href="edit-nilai_10b.php?id=<?php echo $data['nis']; ?> ">
                    <button type="button" class="btn btn-warning">Edit</button>
                    <td align="center" width="80"><a href="hapus-nilai_10b.php?id=<?php echo $data['nis']; ?> ">
