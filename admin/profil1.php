...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
                ...
                $ambilData = mysqli_query($koneksi,"SELECT * FROM tb_login3 WHERE kode_user ='$user'");
            ...
            <body>
               <form action="" method ="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="id" value="<?php echo $dt ['kode_user']?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
