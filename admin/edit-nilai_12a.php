<?php
    ...
    $id = $_GET['id'];
    $ambilData = mysqli_query($koneksi,"SELECT * FROM nilai_12a WHERE nis='$id'");
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="header"><b>Edit Nilai Siswa Kelas 12A</b></div>
        <div class="info">
        <head>
            <meta charset="utf-8">
               ...
               <form action="" method ="post">
                    ...
                    <?php
                        ...
                        if(isset($_POST['proses']))
                        {
                            ...
                            $olga= $_POST['olga'];
                            $total= $_POST['total'];
                            $tambah= mysqli_query($koneksi,"UPDATE  nilai_12a SET nama='$nama',b_indo='$b_indo',b_ing='$b_ing',mtk='$mtk',fisika='$fisika',kimia='$kimia',biologi='$biologi',agama='$agama',olga='$olga',total='$total' WHERE nis='$id'");
                            if($tambah){
                                ?>
                                <script type="text/javascript">
