<?php
      ...
      $id = $_GET['id'];
      $ambilData = mysqli_query($koneksi,"DELETE FROM data_guru WHERE no='$id'");    
?>
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="header">Data Diri Guru</div>
        <div class="info">
        <head>
            <meta charset="utf-8">
        ...
        <br>
            <body>
            <a href="cetak_guru.php"><button type="button" class="btn btn-outline-success btn-lg btn-block">Cetak</button>
            <br>
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    $cari=$_POST['cari'];
                    $query = mysqli_query($koneksi,"SELECT * FROM data_guru WHERE nama LIKE '$cari%'");
                }else{
            ...
            ?>
                <tr>
                    ...
                    <td align="center" width="80"><a href="edit-guru.php?id=<?php echo $data['no']; ?> ">
                    <button type="button" class="btn btn-warning">Edit</button>
                    <td align="center" width="80"><a href="hapus-guru.php?id=<?php echo $data['no']; ?>">
