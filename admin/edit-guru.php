...
@session_start();
    ...
    $id = $_GET['id'];
    $ambilData = mysqli_query($koneksi,"SELECT * FROM data_guru WHERE no ='$id'");
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="header">Edit Guru</div>
        <div class="info">
        <head>
            <meta charset="utf-8">
            ...
            <body>
               <form action="" method ="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="no" value="<?php echo $data ['no']?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="colFormLabel" class="col-sm-2 col-form-label">WALI KELAS</label>
                        <div class="col-sm-10">
                   ...
                   if(isset($_POST['proses']))
                   {
                       ...
                       $alamat= $_POST['alamat'];
                       $tlp= $_POST['tlp'];
                       $tambah= mysqli_query($koneksi,"UPDATE  data_guru SET nama='$nama',kelas='$kelas',tempat='$tempat',tanggal='$tanggal',alamat='$alamat',tlp='$tlp',agama='$agama',jenis='$jenis' WHERE no='$no'");
                       if($tambah){
                           ?>
