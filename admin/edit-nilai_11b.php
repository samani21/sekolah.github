<?php
    ...
    $id = $_GET['id'];
    $ambilData = mysqli_query($koneksi,"SELECT * FROM nilai_11b WHERE nis='$id'");
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="header"><b>Edit Nilai Kelas 11B</b></div>
        <div class="info">
        <head>
            <meta charset="utf-8">
               ...
               <form action="" method ="post">
                    ...
                    <?php
                        ...
                        if(isset($_POST['proses']))
                        {
                            ...
                            $olga= $_POST['olga'];
                            $total= $_POST['total'];
                            $tambah= mysqli_query($koneksi,"UPDATE  nilai_11b SET nama='$nama',b_indo='$b_indo',b_ing='$b_ing',mtk='$mtk',ekonomi='$ekonomi',sosial='$sosial',geografi='$geografi',agama='$agama',olga='$olga',total='$total' WHERE nis='$id'");
                            if($tambah){
                                ?>
                                <script type="text/javascript">
