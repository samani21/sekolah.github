<?php
      ...
      $id = $_GET['id'];
      $ambilData = mysqli_query($koneksi,"DELETE FROM data_siswa_11b WHERE nis='$id'");
...
<html>
    ...
    <nav class="sidebar">
        ...
        <div class="header">Laporan Data Siswa Kelas 11B</div>
        <div class="info">
        <head>
            <meta charset="utf-8">
        ...
        <br>
            <body>
            <a href="cetak_11b.php"><button type="button" class="btn btn-outline-success btn-lg btn-block">Cetak</button>
            <br>
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    $cari=$_POST['cari'];
                    $query = mysqli_query($koneksi,"SELECT * FROM data_siswa_11b WHERE nama LIKE '$cari%'");
                }else{
                    $query= mysqli_query($koneksi,"SELECT * FROM data_siswa_11b");
                }
            ...
            ?>
                <tr>
                    ...
                    <td align="center" width="80"><a href="edit-siswa_11b.php?id=<?php echo $data['nis']; ?> ">
                    <button type="button" class="btn btn-warning">Edit</button>
                    <td align="center" width="80"><a href="hapus-siswa_11b.php?id=<?php echo $data['nis']; ?>">
