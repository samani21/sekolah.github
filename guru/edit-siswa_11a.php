<?php
    ...
    $id = $_GET['id'];
    $ambilData = mysqli_query($koneksi,"SELECT * FROM data_siswa_11a WHERE nis='$id'");
...
<html>
    ...
    <nav class="sidebar">
        ...
        <div class="header">Tambah Data Siswa Kelas 11a</div>
        <div class="info">
        <head>
            <meta charset="utf-8">
            ...
            <body>
               <form action="" method ="post">
                    ...
                    if(isset($_POST['proses']))
                    {
                        ...
                        $alamat= $_POST['alamat'];
                        $tlp= $_POST['tlp'];
                        $tambah= mysqli_query($koneksi,"UPDATE  data_siswa_11a SET nama='$nama',kelas='$kelas',tempat='$tempat',tanggal='$tanggal',alamat='$alamat',tlp='$tlp' WHERE nis='$id'");
                        if($tambah){
                            ?>
