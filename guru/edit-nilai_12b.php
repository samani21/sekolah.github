<?php
    ...
    $id = $_GET['id'];
    $ambilData = mysqli_query($koneksi,"SELECT * FROM nilai_12b WHERE nis='$id'");
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="header"><b>Edit Nilai Siswa Kelas 12B</b></div>
        <div class="info">
        <head>
            <meta charset="utf-8">
            ...
            <body>
               <form action="" method ="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="ekonomi" id="ekonomi" value="<?php echo $data ['ekonomi']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="colFormLabel" class="col-sm-2 col-form-label">SOSIAL</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="sosial" id="sosial" value="<?php echo $data ['sosial']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="colFormLabel" class="col-sm-2 col-form-label">GEOGRAFI</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="geografi" id="geografi" value="<?php echo $data ['geografi']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <?php
                        ...
                        if(isset($_POST['proses']))
                        {
                            ...
                            $olga= $_POST['olga'];
                            $total= $_POST['total'];
                            $tambah= mysqli_query($koneksi,"UPDATE  nilai_12b SET nama='$nama',b_indo='$b_indo',b_ing='$b_ing',mtk='$mtk',ekonomi='$ekonomi',sosial='$sosial',geografi='$geografi',agama='$agama',olga='$olga',total='$total' WHERE nis='$id'");
                            if($tambah){
                                ?>
                                <script type="text/javascript">
