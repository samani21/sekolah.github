...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
                ...
                $ambilData = mysqli_query($koneksi,"SELECT * FROM tb_loging WHERE kode_user ='$user'");
            ...
            <body>
               <form action="" method ="post">
                    <div class="form-group row">
                        <label for="colFormLabel" class="col-sm-2 col-form-label">No Guru</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="no" value="<?php echo @$dt ['kode_user']?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
