<?php
      ...
      $id = $_GET['id'];
      $ambilData = mysqli_query($koneksi,"DELETE FROM data_siswa_11a WHERE nis='$id'");
...
<html>
    ...
    <nav class="sidebar">
        ...
        <br>
            <body>
            <a href="cetak_11a.php"><button type="button" class="btn btn-outline-success btn-lg btn-block">Cetak</button>
            <br>
            ...
            ?>
                <tr>
                    ...
                    <td align="center" width="80"><a href="hapus-siswa1_11a.php?id=<?php echo $data['nis']; ?>">
